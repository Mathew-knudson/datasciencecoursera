...
Finally, the data were grouped by activity and subject, and then the summarize_all command was used to generate means for each variable, for each activity-subject combination. This was written to the tidycsv.
